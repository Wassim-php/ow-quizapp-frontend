          ...
          <div className="p-4">
            ...
            <div className="bg-green-50 p-3 rounded-lg border border-green-200 mb-4">
              ...
              <p className="text-xs text-green-600">
                You scored 85% on your A320 practice test, passing most of 75.
            ...
            {/* Time Information */}
            <h3 className="font-bold text-base border-t pt-4 mt-4">
              Time Information
            </h3>
            <ul className="text-sm space-y-1 mt-2">
              ...
              <li>
                ...
                <span>9/1/2024, 0:52:02 PM</span>
              </li>
              <li>
                <span className="text-gray-500">Finished At:</span>{" "}
                <span>9/1/2024, 1:02:02 PM</span>
              </li>
            </ul>
